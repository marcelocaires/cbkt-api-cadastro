...
public class AtletaGraduacao {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "atleta_graduacao_sequence")
    @SequenceGenerator(name = "atleta_graduacao_sequence", sequenceName = "atleta_graduacao_sequence", allocationSize = 1)
